...
module.exports = memeifier = function (app) {
    ...
    /**
     * Splits text into the maximum length at sensible points in a sentence or tweets.
     * todo: make recursive and create n parts instead of 2.
     **/
    ...
    /**
     * Determines the maximum fitable font that can fit 
     * on a single line in the image
     **/
    ...
    /**
     * Writes a caption in one or two lines based on the vertical offset (y)
     **/
    ...
    /**
     * Makes the meme.
     * Awful spaghetti code due to some last minute 4am error handling
     * of unsupported image types.
     **/
        ...
        try {
            ...
            downloadFile(imgSrc, streamId, localFileFullPath, function (err, fileBuffer) {
                    if (err) {
                        ...
                        /**
                         * First pass at loading and processing the image
                         * If img.onload fails, a second attempt is made
                         * adter using imagemagick to convert the image to a 
                         * valid image type
                         **/
                        img = new Image;
                        img.onload = function () {
                            ...
                            //Save the image to s3 by default
                        ...
                        //The image type was likely not supported, in here we 
                        //attempt to convert the image to a good type and process again                        
